...
class PresentationRequest:
    ...
    VALID_THEMES = {
        ...
        'midnight_purple', 'charcoal_orange', 'ice_blue', 'sand_gold',
        'canva_ocean', 'canva_sunset', 'canva_violet', 'canva_mint',
        'canva_rose', 'canva_amber', 'canva_indigo', 'canva_slate',
        # Classic
        'slate_crimson',
        'classic_royal', 'classic_olive', 'classic_maroon', 'classic_slate_blue',
        # Premium
        'noir', 'atlas', 'sakura',
        'premium_obsidian', 'premium_royal_night', 'premium_emerald', 'premium_copper',
    }
